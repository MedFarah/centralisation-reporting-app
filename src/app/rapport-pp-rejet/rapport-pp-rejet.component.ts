...
@Component({
  selector: 'app-rapport-pp-rejet',
  templateUrl: './rapport-pp-rejet.component.html',
  styleUrls: ['./rapport-pp-rejet.component.css']
})
export class RapportPPRejetComponent implements OnInit {
  ...
  upload(): void {
    ...
    if (this.selectedFiles) {
      ...
      if (file) {
        ...
        this.service.uploadPP(this.currentFile).subscribe(
          (event: any) => {
